  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>PROTECT YOUR AGENCY DATA</Text>
      </View>
      ...
      <View style={styles.content}>
        <GlassCard style={styles.card} intensity={20}>
          ...
          <Text style={styles.title}>Neural Protection</Text>
          <Text style={styles.description}>
            The security and access management suite is being configured for mobile biometrics and MFA. 
