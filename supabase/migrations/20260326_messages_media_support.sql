-- Upgrade messages table for media support
...
-- Update send_message_v2 RPC to accept optional media fields
-- Drop and recreate to avoid signature mismatch
DROP FUNCTION IF EXISTS send_message_v2(UUID, TEXT);
...
BEGIN
  ...
  INSERT INTO messages (
    ...
    message_type, file_url, file_name, file_size, mime_type,
    is_read, status
  )
  VALUES (
    p_conversation_id, v_sender_id, p_content,
    p_message_type, p_file_url, p_file_name, p_file_size, p_mime_type,
    false, 'sent'
  )
