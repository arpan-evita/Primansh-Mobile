-- 1. Add missing columns to the conversations table
...
-- 2. Unified RPC for creating or finding conversations with context and participants
...
-- 3. RPC to find a common 1:1 conversation between two users
